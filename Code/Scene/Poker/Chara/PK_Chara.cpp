...
PK_Chara::PK_Chara() :coin(coinIni), bbView(BBView::hide), card(std::deque<PK_Card*>()), coinBack(std::deque<Cmp_Image*>()), cmp(ComponentArray()){
...
void PK_Chara::GetHandNum(std::deque<int>& set) const {
